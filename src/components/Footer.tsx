        ...
        <div className="footer__box">
            ...
            <div className="footer__list-box">
                ...
                <ul className="footer__list">
                    ...
                    <li className="footer__list-item">Phone: <a href="tel:555-123-4567">555-123-4567</a></li>
                    <li className="footer__list-item">Email: <a href="mailto:example@example.com">example@example.com</a></li>
                </ul>
            </div>
        </div>
    </footer>
